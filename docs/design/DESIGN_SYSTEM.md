...
| Código confirmado | `#12784a / #e6f7ee` sem borda | `authenticated` (página pública) | Renomeado de "Identidade confirmada" na Fase 2: o código por e-mail, SMS ou WhatsApp prova a posse do canal, não a identidade (arquitetura §2, regra T1 do roadmap, que prevalecem sobre este documento). O mock original conserva o texto antigo. |
