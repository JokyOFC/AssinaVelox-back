...
- Certificado da TSA: exatamente uma extensão *extended key usage*, com `id-kp-timeStamping` (1.3.6.1.5.5.7.3.8), e ela **MUST be critical**.
...
- Tabela A.22 (dicionários PAdES): `DocTimeStamp` com `SubFilter ETSI.RFC3161`; DSS e *Document Time-stamp* são P/P/O/O e VRI é P*/P*/O/O, sempre na ordem RB/RT/RC/RA. Nota: "Caso seja utilizado DSS para os formatos RB e RT, deve-se usar o VRI."
...
Definições dos níveis: ETSI EN 319 142-1 V1.2.1 (2024-01), https://www.etsi.org/deliver/etsi_en/319100_319199/31914201/01.02.01_60/en_31914201v010201p.pdf. B-T acrescenta um token confiável provando que a assinatura existia em uma data; B-LT embute todo o material de validação; B-LTA acrescenta carimbos de documento para validação muito tempo depois. DSS seguido de *document time-stamp*.
