        ...
        <div className="border-danger-border bg-card shadow-card flex flex-wrap items-center justify-between gap-4 rounded-xl border p-5">
            <div className="min-w-0">
                ...
                <p className="text-muted-foreground mt-1 text-[13px] leading-[1.5]">
                    Remove seu usuário e o acesso a todas as organizações.
                    Organizações das quais você é o único proprietário precisam
                    ser transferidas ou excluídas antes.
                </p>
            </div>
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Esta ação é permanente. Confirme sua senha para
                            excluir a conta e todos os dados pessoais
                            associados.
                        </DialogDescription>
                    </DialogHeader>
