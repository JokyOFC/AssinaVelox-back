                ...
                <div className="flex flex-col gap-4 rounded-xl border border-border bg-card p-5 shadow-card">
                    ...
                    <div className="grid gap-3" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
                        <div className="grid gap-1.5">
                            <Label htmlFor="expires_in_days">Prazo para assinatura</Label>
                            <Select
                                value={String(form.data.expires_in_days)}
                                onValueChange={(v) => form.setData('expires_in_days', Number(v))}
                            >
                                <SelectTrigger id="expires_in_days" className="w-full">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                        ...
                        <div className="grid gap-1.5">
                            <Label htmlFor="signing_order">Ordem de assinatura</Label>
                            <Select
                                value={form.data.signing_order}
                                onValueChange={(v) => form.setData('signing_order', v as SigningOrder)}
                            >
                                <SelectTrigger id="signing_order" className="w-full">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    {(Object.keys(signingOrderLabels) as SigningOrder[]).map((key) => (
                        ...
                        <div className="grid gap-1.5">
                            <Label className="flex items-center gap-2">
                                Lembretes automáticos <Badge variant="phase">Fase 2</Badge>
                            </Label>
                            <Select value="off" disabled>
                                ...
                                <SelectContent>
                                    <SelectItem value="off">Desativados</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                    </div>
                    <div className="grid gap-1.5">
                        <span className="text-[13px] font-semibold">Autenticação padrão dos signatários</span>
                        ...
                        <span className="text-[12px] leading-[1.5] text-muted-foreground">
                            O código por e-mail é o método disponível na Fase 1. Outros fatores aumentam a robustez do
                            aceite e chegam na Fase 2.
                        </span>
                    </div>
                </div>

                <div className="flex flex-col rounded-xl border border-border bg-card p-5 shadow-card">
                    <Heading variant="small" title="Canais e recursos" className="mb-2" />
                    <SwitchRow
                    ...
                    <SwitchRow
                        ...
                        phase2
                    />
                    <SwitchRow title="Envio por SMS" description="Alternativa ao WhatsApp" checked={false} disabled phase2 />
                    <SwitchRow
                    ...
                    <SwitchRow
                        ...
                        onCheckedChange={(v) => form.setData('allow_typed_signature', v)}
                    />
                    <SwitchRow
                        ...
                        onCheckedChange={(v) => form.setData('allow_uploaded_signature', v)}
                    />
                    <SwitchRow
                        ...
                        onCheckedChange={(v) => form.setData('initials_on_all_pages', v)}
                    />
                </div>
