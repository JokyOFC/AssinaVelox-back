 ...
 */
final class TemplateRole implements \JsonSerializable
{
    /**
    ...
    public function __construct(
        ...
        public readonly string $participantRole,
        public readonly string $participantRoleLabel,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            participantRoleLabel: $data['participant_role_label'] ?? null,
            raw: $data,
        );
    }
