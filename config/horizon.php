...
return [
    ...
    */
    ...
    'environments' => [
        'production' => [
            'supervisor-default' => [
                'maxProcesses' => (int) env('HORIZON_DEFAULT_PROCESSES', 6),
                'balanceMaxShift' => 1,
                'balanceCooldown' => 3,
            ],
            'supervisor-conversions' => [
                'maxProcesses' => (int) env('HORIZON_CONVERSIONS_PROCESSES', 2),
            ],
            'supervisor-finalization' => [
                'maxProcesses' => (int) env('HORIZON_FINALIZATION_PROCESSES', 2),
            ],
        ],

        'local' => [
            'supervisor-default' => ['maxProcesses' => 2],
            'supervisor-conversions' => ['maxProcesses' => 1],
            'supervisor-finalization' => ['maxProcesses' => 1],
        ],
    ],
];
